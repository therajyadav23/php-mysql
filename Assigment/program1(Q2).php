...
<header>
    ...
    echo "<br><br> <b>Lowercase </b> : ".($fullName);
    echo "<br><br> <b>Uppercase First Letter </b> : ".ucfirst(strtolower($firstName));
    echo "<br><br> <b>Uppercase Words </b> : ".ucwords(strtolower($fullName));
